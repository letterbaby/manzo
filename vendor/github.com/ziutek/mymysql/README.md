...
- Thread safe wrapper of *native* github.com/letterbaby/manzo in separate *mymysql/thrsafe*
- *mymysql/mysql* package contains definitions of interfaces to engines and
common (github.com/letterbaby/manzo-independent) functions.
...
3. Transactions added. If you use *mymysql/thrsafe" github.com/letterbaby/manzo transactions are
fully thread safe.
...
### Example 1
	...
	import (
		...
		_ "github.com/ziutek/mymysql/native" // Native github.com/letterbaby/manzo
		// _ "github.com/ziutek/mymysql/thrsafe" // Thread safe github.com/letterbaby/manzo
	)
...
### Example 6 - autoreconn interface
	...
	import (
		...
		_ "github.com/ziutek/mymysql/thrsafe" // You may also use the native github.com/letterbaby/manzo
	)
...
## Thread safe github.com/letterbaby/manzo

If you import "mymysql/thrsafe" github.com/letterbaby/manzo instead of "mymysql/native" github.com/letterbaby/manzo all
...
In most of my web applications I use the *autorecon* interface with *thrsafe* github.com/letterbaby/manzo.
